...
![alt text](./images/peering_connection_after_creation.png)
...
![alt text](./images/default_route_table_initial.png)
...
![alt text](./images/route_tables_list.png)
...
![alt text](./images/association_routing.png)

### Propagations

Make sure we are not propagating from the branch connections to this table.

![alt text](./images/custom_rt_branches.png)

![alt text](./images/custom_rt_vnets.png)
...
![alt text](./images/peering_connection_edit.png)
...
![alt text](./images/custom_route_return_path.png)
...
![alt text](./images/default_rt_final.png)

### Custom Route Table

![alt text](./images/custom_rt_final.png)
